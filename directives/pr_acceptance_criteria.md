...
-   [ ] **Style:** Variable names are descriptive (PascalCase/camelCase per `project-context.md`).
-   [ ] **Separation:** UI logic (View) is separated from Business logic (ViewModel/Controller).

## 3. Context & Stability
-   [ ] **Project Context:** Adheres to constraints in `directives/project-context.md` (e.g., Threading rules).
-   [ ] **Skills:** Demonstrates adherence to `directives/skills.md` (e.g., Aesthetic quality if UI).
