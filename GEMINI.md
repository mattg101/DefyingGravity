...
- **SOPs:** Directives are SOPs written in the workspace's `.agent/rules/directives/`. They define Roles and Goals.
- **Skill-Driven:** Agents check the workspace's `.agent/rules/directives/` for specialized knowledge.
